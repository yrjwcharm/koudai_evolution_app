...
@interface UIConfigModel : NSObject
/**
 读卡标题，默认为：身份认证，仅需一贴
 */
...
/**
 读卡标题颜色，默认为：#333333
 */
@property (nonatomic, copy) NSString *readTitleColor;
/**
 读卡按钮文字颜色，默认为：#FFFFFF
 */
@property (nonatomic, copy) NSString *readBtnTextColor;
/**
 读卡按钮背景颜色，默认为：#333333
 */
@property (nonatomic, copy) NSString *readBtnBgColor;
/**
 读卡底部提示文本，默认为：个人信息已加密保护
 */
@property (nonatomic, copy) NSString *bottomTipText;
/**
 读卡底部提示文本颜色，默认为：#CDCDCD
 */
@property (nonatomic, copy) NSString *bottomTipTextColor;
/**
 确认信息按钮文字颜色，默认为：#FFFFFF
 */
@property (nonatomic, copy) NSString *sureMessageTextColor;
/**
 确认信息按钮背景颜色，默认为：#333333
 */
@property (nonatomic, copy) NSString *sureMessageBgColor;
/**
 盾牌icon, 传入UIImage对象
 */
@property (nonatomic, strong) UIImage *bottomTipImage;
@end
...
- (UIConfigModel *)getUIConfigModel;
...
/**
 ...
 @param vc 当前页面控制器
 */
- (void)startReadIDCardWithController:(UIViewController *)vc uiconfig:(UIConfigModel *)configModel;
