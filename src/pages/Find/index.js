 ...
 * @Author: yhc
 * @LastEditors: yhc
 * @LastEditTime: 2021-02-01 19:09:05
 * @Description:发现
 */
...
const Index = (props) => {
    ...
    return (
        <ScrollView>
            <View style={styles.container} id="logo">
                <LinearGradient
                    start={{x: 0, y: 0}}
                    end={{x: 0, y: 1}}
                    colors={['#fff', '#F5F6F8']}
                    ...
                    <View style={{marginBottom: px(20)}}>
                        ...
                        <View style={[styles.card, {borderRadius: 8}, Style.flexRow]}>
                            <View style={{padding: Space.cardPadding, flex: 1}}>
                                ...
                                <Text style={[styles.radio, {fontSize: px(26), marginTop: px(16)}]}>
                                    132.87%~156.58%
                                </Text>
                                <Text style={styles.light_text}>35+必备 ｜ 美好生活提前储备</Text>
                            </View>
                            <Image
                                ...
                                source={{uri: 'https://static.licaimofang.com/wp-content/uploads/2021/01/图片33.png'}}
                            />
                        </View>
                    </View>
                    {/* 专业理财 */}
                    <View style={{marginBottom: px(20)}}>
                        ...
                        <ScrollView
                            ...
                            <View style={[styles.major_card, styles.card]}>
                                ...
                                <Text style={[styles.radio, {fontSize: px(26), marginTop: px(16)}]}>6.87%~11.58%</Text>
