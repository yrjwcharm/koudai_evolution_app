        ...
        <View style={{flex: 1, backgroundColor: Colors.bgColor}}>
            {Object.keys(data).length > 0 && (
                <ScrollView keyboardShouldPersistTaps="handled">
                    <View style={styles.fund_view}>
                        <View style={styles.fund_wrap}>
                            <Text style={styles.fund_name}>{state.fund_name}</Text>
                            <Text style={styles.fund_code}>{state.fund_code}</Text>
                        </View>
                    </View>
                    {showMask && (
                        <Mask
