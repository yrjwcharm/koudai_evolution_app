...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, PixelRatio} from "react-native";
...
export default  (props) => {
  ...
  useFocusEffect(
    ...
    const handlerDpr = useCallback(() => {
      let dpr = PixelRatio.get()
      switch(true) {
        case dpr <= 1:
          return require('../../assets/img/lowBuySignal/paraphrase@1.png');
        case 1 < dpr && dpr <= 2:
          return require('../../assets/img/lowBuySignal/paraphrase@2.png');
        case dpr > 2:
          return require('../../assets/img/lowBuySignal/paraphrase@3.png');
      }
    },['123'])
      ...
      <ScrollView
        ...
        <View style={styles.lowBuyInfo}>
          <View style={[styles.lowBuyInfoRatio, Style.flexCenter]}>
              ...
              <Text style={styles.lowBuyInfoRatioDesc}>
                {data.desc}
              </Text>
          </View>
          <View>
            <Text style={[styles.lowBuyInfoText, Space.marginVertical]}>
                {data.lowBuyInfoText}
            </Text>
          </View>
          <View>
        ...
        <View style={styles.blockStyle}>
          ...
          <View style={styles.positionCost}>
            <Text style={styles.positionCostText}>
              持仓成本
            </Text>
            <Text style={{
