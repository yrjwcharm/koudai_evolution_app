    ...
    return (
        <View
            ...
            <View style={styles.header}>
                ...
                />
                <Text style={styles.title}>越跌越买</Text>
            </View>
            <View style={styles.ratePanel}>
                <Text style={[styles.rateText, {color: '#121D3A'}]}>4,340.53</Text>
                ...
                <Text style={[styles.rateText, {color: '#E74949'}]}>7,670.43</Text>
            </View>
