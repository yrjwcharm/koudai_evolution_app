...
const ProbabilitySignal = ({onCardHeight}) => {
    ...
    return (
        <View
            ...
            <View style={styles.header}>
                ...
                />
                <Text style={styles.title}>概率信号</Text>
            </View>
            <View style={styles.ratePanel}>
                <Text style={[styles.rateText, {color: '#121D3A'}]}>1300.66</Text>
                ...
                <Text style={[styles.rateText, {color: '#E74949'}]}>4564.43</Text>
            </View>
