...
export default function PortfolioAssets({navigation}) {
                        ...
                        <View style={styles.padding_sty}>
                            {Object.keys(card).length > 0 && (
                                <View style={styles.plan_card_sty}>
                                    ...
                                    <View
                                        style={[Style.flexRow, {justifyContent: 'space-between', marginTop: text(14)}]}>
                                            ...
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    style={{
                                                        ...
                                                        marginRight:
                                                            _index < card.button_list.length - 1 ? text(10) : 0,
                                                    }}>
                                                    <Text
                                                        style={{
