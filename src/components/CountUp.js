/*
 * @Date: 2021-01-30 11:19:48
 * @Author: yhc
 * @LastEditors: yhc
 * @LastEditTime: 2021-01-30 11:19:49
 * @Description:
 */
...
class CountUp extends Component {
    ...
    checkProps = (updatedProps) => {
        const {start, suffix, prefix, redraw, duration, separator, decimals, decimal} = this.props;
    ...
    start = () => {
        ...
        const run = () => this.instance.start(() => onEnd({pauseResume, reset, start, update}));
