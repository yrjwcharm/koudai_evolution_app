...
export default class InputBar extends PureComponent {
    ...
    renderIcon = () => {
        ...
        const sendAbleIcon = sendIcon || (
            <ImageComponent source={require('../source/image/sendAble.png')} style={{width: 30, height: 30}} />
        );
        ...
        if (usePlus) {
            if (messageContent.trim().length) {
                ...
                return (
                    plusIcon || (
                        <ImageComponent source={require('../source/image/more.png')} style={{width: 30, height: 30}} />
                    )
                );
            }
        } else {
    ...
    renderEmojieIcon = () => {
        ...
        if (isEmojiShow) {
            return (
                keyboardIcon || (
                    <ImageComponent source={require('../source/image/keyboard.png')} style={{width: 30, height: 30}} />
                )
            );
        } else {
            return (
                emojiIcon || (
                    <ImageComponent source={require('../source/image/emoji.png')} style={{width: 30, height: 30}} />
                )
            );
        }
    };
